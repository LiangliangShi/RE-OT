...
class BalancedSoftmax(_Loss):
    ...
    def forward(self, input, label, reduction="mean", **kwargs):
        return balanced_softmax_loss(label, input, self.sample_per_class, reduction, **kwargs)


def balanced_softmax_loss(labels, logits, sample_per_class, reduction, **kwargs):
